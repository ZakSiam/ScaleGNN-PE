# run_qm9_gp_baselines.py
"""
Fixed (frozen) GNN embedding + GP baselines on QM9.
...
def run_one(args):
    ...
    graphs, graph_rewards, feat_dim = load_qm9_domain(
        root=args.qm9_root,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Fixed-GNN-embedding GP baselines on QM9 (no sklearn)")
    ...
    # output/logging
    parser.add_argument("--exp_result_folder", type=str, default="results/qm9_gp_baselines_T300_N1000")
