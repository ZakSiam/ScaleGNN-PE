...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="GNN-UCB on ZINC 250k (penalized logP)")
    ...
    parser.add_argument("--exp_result_folder", type=str, default="results/zinc_gnnucb_T300_N1000")
