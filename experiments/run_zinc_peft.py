# PhasedGNN-UCB (GNN-PE) on ZINC 250k (penalized logP) with two acceleration axes:
...
#
# This is a superset of run_zinc_phasedgp.py: with --peft none and no scan flags it reproduces the
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="PhasedGNN-UCB (GNN-PE) on ZINC 250k (penalized logP) with PEFT + scan acceleration")
    ...
    parser.add_argument("--exp_result_folder", type=str, default="results/zinc_peft_T300_N1000")
